...
cap = cv2.VideoCapture("20241024_143145.mp4")  # Abre o vídeo "20241023_104653.mp4"
...
while True:                             # Inicia um loop infinito
    ...
    roi = frame[50:440, 200:860]  # [50:540,200:960]

    # MASKING METHOD 1                   # Método de mascaramento 1
    mask = object_detector.apply(roi)   # Aplica o detector de objetos à ROI
    _, mask = cv2.threshold(mask, 250, 255, cv2.THRESH_BINARY)  # Aplica um limiar binário à máscara
    ...
    for cnt in contours:                # Para cada contorno encontrado
        ...
        # THRESHOLD                      # Limite
        if area > 2200:                 # Se a área for maior que 1000
